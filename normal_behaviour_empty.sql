...
UPDATE Iscrizioni_Appello SET voto='<vuoto>', stato='non inserito' WHERE id_corso=1 AND data='2025-06-20' AND id_studente BETWEEN 11 AND 13;
UPDATE Iscrizioni_Appello SET voto='<vuoto>', stato='non inserito' WHERE id_corso=1 AND data='2025-06-20' AND id_studente BETWEEN 14 AND 16;
UPDATE Iscrizioni_Appello SET voto='<vuoto>', stato='non inserito' WHERE id_corso=1 AND data='2025-06-20' AND id_studente=17;
UPDATE Iscrizioni_Appello SET voto='<vuoto>', stato='non inserito' WHERE id_corso=1 AND data='2025-06-20' AND id_studente=18;
UPDATE Iscrizioni_Appello SET voto='<vuoto>', stato='non inserito' WHERE id_corso=1 AND data='2025-06-20' AND id_studente=19;
...
UPDATE Iscrizioni_Appello SET voto='<vuoto>', stato='non inserito' WHERE id_corso=4 AND data='2026-01-22' AND id_studente BETWEEN 11 AND 14;
UPDATE Iscrizioni_Appello SET voto='<vuoto>', stato='non inserito' WHERE id_corso=4 AND data='2026-01-22' AND id_studente BETWEEN 15 AND 18;
UPDATE Iscrizioni_Appello SET voto='<vuoto>', stato='non inserito' WHERE id_corso=4 AND data='2026-01-22' AND id_studente BETWEEN 19 AND 20;
...
UPDATE Iscrizioni_Appello SET voto='<vuoto>', stato='non inserito' WHERE id_corso=6 AND data='2025-06-18' AND id_studente BETWEEN 26 AND 30;
UPDATE Iscrizioni_Appello SET voto='<vuoto>', stato='non inserito' WHERE id_corso=6 AND data='2025-06-18' AND id_studente BETWEEN 31 AND 33;
UPDATE Iscrizioni_Appello SET voto='<vuoto>', stato='non inserito' WHERE id_corso=6 AND data='2025-06-18' AND id_studente = 34;

-- Popoliamo l'appello di Chimica Generale (11, '2025-07-10')
INSERT INTO Iscrizioni_Appello (id_corso, data, id_studente, voto, stato)
SELECT 11, '2025-07-10', id, '<vuoto>', 'non inserito' FROM Utente WHERE corso_laurea = 'Scienze Biologiche' AND id <= 50;
UPDATE Iscrizioni_Appello SET voto='<vuoto>', stato='non inserito' WHERE id_corso=11 AND data='2025-07-10' AND id_studente BETWEEN 41 AND 45;
UPDATE Iscrizioni_Appello SET voto='<vuoto>', stato='non inserito' WHERE id_corso=11 AND data='2025-07-10' AND id_studente BETWEEN 46 AND 50;
