...
/**
 * Servlet Filter implementation class ProfessorAuthFilter
 */

public class ProfessorAuthFilter extends HttpFilter implements Filter {
	 private static final long serialVersionUID = 1L;   
	
    /**
     * @see HttpFilter#HttpFilter()
     */
    public ProfessorAuthFilter() {
        super();
